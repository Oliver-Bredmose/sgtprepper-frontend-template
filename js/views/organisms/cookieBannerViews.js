...
export const cookieBannerView = () => {
    const overlay = Div('fixed hidden inset-0 z-[9998] bg-black/70 flex items-end md:items_center md: justify-center')
    overlay.id = 'cookie-overlay'
    overlay.setAttribute('aria-hidden', 'flase')
    ...
    const wrap = Div('flex-col md:flex-row md:items-center md:justify-between gap-4')
